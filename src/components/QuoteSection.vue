<template>
  <section class="section-lg bg-gradient context-dark">
    <div class="container">
        ...
        <div class="col-md-7">
          <div class="owl-carousel owl-quote-2" data-owl="{&quot;dots&quot;:true}" data-items="1">
            ...
            <div class="quote quote-md">
              ...
              <cite class="quote-cite big">Matthäus 28 : 19</cite>
              <q class="quote-text h4">Darum geht zu allen Völkern und macht alle Menschen zu meinen Jüngern; tauft sie auf den Namen des Vaters und des Sohnes und des Heiligen Geistes</q>
            </div>
            <!-- Quote icon md-->
            <div class="quote quote-md">
              <div class="quote-icon">
              ...
              <q class="quote-text h4">Niemand soll dich wegen deiner Jugend gering schätzen. Sei den Gläubigen ein Vorbild in deinen Worten, in deinem Lebenswandel, in der Liebe, im Glauben, in der Lauterkeit.</q>
            </div>
          </div>
        </div>
      </div>
